...
def test_smp_query():
    ...
    smp_url = "https://smp-api.sc-b2b.us/bdxr-smp-2/urn%3Aoasis%3A"\
                     "names%3Atc%3Aebcore%3Apartyid-type%3Aiso6523%3A0088%3A%3A"
    service_url="https://smp-api.sc-b2b.us/bdxr-smp-2/urn%3Aoasis%3Anames"\
                          "%3Atc%3Aebcore%3Apartyid-type%3Aiso6523%3A0088%3A%3A"
    services = "/services/bdx-docid-qns%3A%3Aurn%3Aoasis%3Anames%3Aspecification"\
    ...
    for index, urn in enumerate(urns):
        ...
        log.info(msg)
        service_group_url_test = query.smp_create_srvc_group_url_query(urn, log)
