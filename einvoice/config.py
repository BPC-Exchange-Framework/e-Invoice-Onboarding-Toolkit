...
#
"""Configuration file for package with global values and single logging instance."""
...
class Logger():
    ...
    def __init__ (self):
        """Entry point into the application and define application variables."""
        self.log = None

    def create_logger(self):
        """Create an instance of a logger to be used by the entire application.."""
